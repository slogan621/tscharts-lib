...
public class RoutingSlipEntryREST extends RESTful {
    ...
    public Object deleteRoutingSlipEntry(int entryId) {
        ...
        RoutingSlipEntryREST.AuthJSONObjectRequest request = new RoutingSlipEntryREST.AuthJSONObjectRequest(Request.Method.DELETE, url, null,  new RoutingSlipEntryREST.GetRoutingSlipEntryResponseListener(), new RoutingSlipEntryREST.ErrorListener());
