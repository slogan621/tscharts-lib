...
class Vaccination {
    ...
    var vari = false                    // in the backend, this is "var"
    var vari_date: String? = null
    ...
    fun fromJSONObject(o: JSONObject): Int {
        ...
        try {
            ...
            covid19_date = o.getString("covid19_date")
            covid19_booster = o.getBoolean("covid19_booster")
            covid19_booster_date = o.getString("covid19_booster_date")
            dtap = o.getBoolean("dtap")
            dtap_date = o.getString("dtap_date")
            dt = o.getBoolean("dt")
            dt_date = o.getString("dt_date")
            hib = o.getBoolean("hib")
            hib_date = o.getString("hib_date")
            hepa = o.getBoolean("hepa")
            hepa_date = o.getString("hepa_date")
            hepb = o.getBoolean("hepb")
            hepb_date = o.getString("hepb_date")
            hpv = o.getBoolean("hpv")
            hpv_date = o.getString("hpv_date")
            iiv = o.getBoolean("iiv")
            iiv_date = o.getString("iiv_date")
            laiv4 = o.getBoolean("laiv4")
            laiv4_date = o.getString("laiv4_date")
            mmr = o.getBoolean("mmr")
            mmr_date = o.getString("mmr_date")
            menacwy = o.getBoolean("menacwy")
            menacwy_date = o.getString("menacwy_date")
            menb = o.getBoolean("menb")
            menb_date = o.getString("menb_date")
            pcv13 = o.getBoolean("pcv13")
            pcv13_date = o.getString("pcv13_date")
            ppsv23 = o.getBoolean("ppsv23")
            ppsv23_date = o.getString("ppsv23_date")
            ipv = o.getBoolean("ipv")
            ipv_date = o.getString("ipv_date")
            rv = o.getBoolean("rv")
            rv_date = o.getString("rv_date")
            tap = o.getBoolean("tap")
            tap_date = o.getString("tap_date")
            td = o.getBoolean("td")
            td_date = o.getString("td_date")
            vari = o.getBoolean("vari")                    // in the backend, this is "var"
            vari_date = o.getString("vari_date")
            dtap_hepb_ipv = o.getBoolean("dtap_hepb_ipv")
            dtap_hepb_ipv_date = o.getString("dtap_hepb_ipv_date")
            dtap_ipv_hib = o.getBoolean("dtap_ipv_hib")
            dtap_ipv_hib_date = o.getString("dtap_ipv_hib_date")
            dtap_ipv = o.getBoolean("dtap_ipv")
            dtap_ipv_date = o.getString("dtap_ipv_date")
            dtap_ipv_hib_hepb = o.getBoolean("dtap_ipv_hib_hepb")
            dtap_ipv_hib_hepb_date = o.getString("dtap_ipv_hib_hepb_date")
            mmvr = o.getBoolean("mmvr")
            mmvr_date = o.getString("mmvr_date")
    ...
    fun toJSONObject(includeId: Boolean): JSONObject? {
        ...
        try {
            ...
            data.put("covid19_date", covid19_date)
            data.put("covid19_booster", covid19_booster)
            data.put("covid19_booster_date", covid19_booster_date)
            data.put("dtap", dtap)
            data.put("dtap_date", dtap_date)
            data.put("dt", dt)
            data.put("dt_date", dt_date)
            data.put("hib", hib)
            data.put("hib_date", hib_date)
            data.put("hepa", hepa)
            data.put("hepa_date", hepa_date)
            data.put("hepb", hepb)
            data.put("hepb_date", hepb_date)
            data.put("hpv", hpv)
            data.put("hpv_date", hpv_date)
            data.put("iiv", iiv)
            data.put("iiv_date", iiv_date)
            data.put("laiv4", laiv4)
            data.put("laiv4_date", laiv4_date)
            data.put("mmr", mmr)
            data.put("mmr_date", mmr_date)
            data.put("menacwy", menacwy)
            data.put("menacwy_date", menacwy_date)
            data.put("menb", menb)
            data.put("menb_date", menb_date)
            data.put("pcv13", pcv13)
            data.put("pcv13_date", pcv13_date)
            data.put("ppsv23", ppsv23)
            data.put("ppsv23_date", ppsv23_date)
            data.put("ipv", ipv)
            data.put("ipv_date", ipv_date)
            data.put("rv", rv)
            data.put("rv_date", rv_date)
            data.put("tap", tap)
            data.put("tap_date", tap_date)
            data.put("td", td)
            data.put("td_date", td_date)
            data.put("vari", vari)
            data.put("vari_date", vari_date)
            data.put("dtap_hepb_ipv", dtap_hepb_ipv)
            data.put("dtap_hepb_ipv_date", dtap_hepb_ipv_date)
            data.put("dtap_ipv_hib", dtap_ipv_hib)
            data.put("dtap_ipv_hib_date", dtap_ipv_hib_date)
            data.put("dtap_ipv", dtap_ipv)
            data.put("dtap_ipv_date", dtap_ipv_date)
            data.put("dtap_ipv_hib_hepb", dtap_ipv_hib_hepb)
            data.put("dtap_ipv_hib_hepb_date", dtap_ipv_hib_hepb_date)
            data.put("mmvr", mmvr)
            data.put("mmvr_date", mmvr_date)
