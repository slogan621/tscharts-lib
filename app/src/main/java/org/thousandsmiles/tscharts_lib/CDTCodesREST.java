...
public class CDTCodesREST extends RESTful {
    ...
    private class GetCDTCodesResponseListener implements Response.Listener<JSONArray> {
    ...
    public CDTCodesREST(Context context) {
        setContext(context);
    }

    public Object getCDTCodesList() {
