...
public class COVIDVacREST extends RESTful {
    ...
    public COVIDVacREST(Context context) {
        setContext(context);
    }

    public Object getCOVID19Types() {
        ...
        String url = String.format("%s://%s:%s/tscharts/v1/covidvac/", getProtocol(), getIP(), getPort());
